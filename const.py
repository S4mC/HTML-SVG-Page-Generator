...
<body>
    <div class="container">
        ...
        <div class="section">
            <button id="doBetterHtmlButton" onclick="do_better_html()">Do better html</button>
    ...
    <script>
        ...
        function openFile() {
            pywebview.api.open_file().then(result => {
                if (result.success) {
                    document.getElementById("doBetterHtmlButton").disabled = false;
                    document.getElementById("doBetterHtmlButton").style.cursor = "default";
        ...
        function do_better_html() {
            pywebview.api.do_better_html().then(result => {
                if (result.success) {
                    document.getElementById("doBetterHtmlButton").disabled = true;
                    document.getElementById("doBetterHtmlButton").style.cursor = "not-allowed";
                    updateContent(result.content, document.getElementById('currentFile').textContent);
                    showStatus('Mejorado correctamente');
                } else {
                    showStatus(result.error, true);
                }
            });
